...
const SERVER_VARS: EnvVarRule[] = [
  ...
  { name: "PAGBANK_TOKEN", required: true, description: "PagBank API Token (Bearer)" },
  { name: "PAGBANK_API_URL", required: true, description: "PagBank API URL (ex: https://sandbox.api.pagseguro.com ou https://api.pagseguro.com)" },
